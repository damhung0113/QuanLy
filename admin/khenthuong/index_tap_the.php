...
$next_page = $page_no + 1;
$adjacents = "2";
$result_count = count_data_tap_the(); // tổng số bản ghi
$total_records = mysqli_fetch_array($result_count);
$total_records = $total_records['total_records'];
$total_no_of_pages = ceil($total_records / $total_records_per_page);
$second_last = $total_no_of_pages - 1; // total page minus 1

$list_khen_thuong = select_tap_the($offset, $total_records_per_page); // select và phân trang
...
while ($row = mysqli_fetch_row($list_khen_thuong)) {
  ...
  $content .= '<tr><td style="width: 50px">' . $row[0] .
      '</td><td>' . mysqli_fetch_row(get_ten_khoa($row[2]))[0] .
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-header">
          <a href="./create_tap_the.php" class="btn btn-outline-primary float-right mr-2" role="button"
             style="border-color: #007bff;">Tạo
            khen thưởng tập thể</a>
        </div>
            ...
            <form>
              <tr>
                ...
                <td class="d-flex">
                  ...
                  <a href="index_tap_the.php" class="btn btn-secondary ml-3">Reset</a></td>
              </tr>
            </form>
            <?php echo $content; ?>
            </tbody>
