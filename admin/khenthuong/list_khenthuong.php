...
$content='';
$result= list_khenthuong();
foreach($result as $row){
    $content.= '<tr>
        <td>'.$row['Ma_khen_thuong'].'</td>
        <td>'.$row['Ho_ten'].'</td>
        <td>'.$row['Ten_khoa'].'</td>
        <td>'.$row['Ten_bo_mon'].'</td>
        <td>'.$row['Ten_cap'].'</td>
        <td>'.$row['Ten_hinh_thuc'].'</td>
        <td>'.$row['So_QD'].'</td>
        <td>'.$row['Ngay_QD'].'</td>
        <td>'.$row['Ly_do'].'</td>
        <td>'.'<a class="btn btn-success mr-3" type="button">Sửa</a> <a class="btn btn-success mr-3" type="button">Xóa</a>'.'</td> 
    </tr>';
}
                ...
                <form action="" method="get">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <?php echo '<input type="text" class="form-control" name="ten_cb" " >'; ?>
                        </div>
                        <div class="col-12 col-md-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr style="color:White;background-color:#006699;font-weight:bold;">
                                <th scope="col" >Mã khen thuong</th>
                                <th scope="col">Họ và tên</th>
                                <th scope="col">Khoa</th>
                                <th scope="col">Bộ môn</th>
                                <th scope="col">Cấp quyết định</th>
                                <th scope="col">Hình thức khen thuong</th>
